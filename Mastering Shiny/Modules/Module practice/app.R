...
server <- function(input, output, session){
  a <- species_input_server("species_input_module", reviewedData)
  
  value_box_server("species_value_box_module", 
                   selected_species = a$selected_species, 
                   location_species = a$location_species, 
                   button_trigger = a$button_trigger
  )
